...
작성 2026-08-31 (기준 커밋 93066ab, 회귀 10종 231건). **최종 갱신 2026-09-07 — 회귀 17종 343건,
2026-09-04 하네스 감사(4축 12건) 전량 해소.** 그간 추가: 스키마 계약·배치 only_test·JWT 실경유·
L2 런타임(헤드리스)·이메일 백스톱·flaky 허용목록·알림 스냅샷·테스트 요청 은닉(관리자만)·
거짓통과 봉쇄(양성대조)·SUMMARY 정확 집계. 상세는 §3~§7.
