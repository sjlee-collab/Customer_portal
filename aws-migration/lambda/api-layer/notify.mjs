...
async function writeLogs(results) {
  for (const r of results || []) {
    try {
      await query(
        `insert into log_notification (ticket_id, channel, event_type, recipient, status, error_message)
         values ($1,$2,$3,$4,$5,$6)`,
        [r.ticketId ?? null, r.channel, r.eventType, r.recipient, r.status, r.errorMessage ?? null]
      );
    } catch (e) {
